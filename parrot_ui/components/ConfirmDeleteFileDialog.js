...
export class ConfirmDeleteFileDialog extends Component {
    constructor(props) {
      super(props);
      this.state = { 
        confirm: false
         ...
         <div class="modal-bg">
            <div class="modal">
                ...
                <div class="modal-body ta-center">
                    <button className=${'btn-square-100 mb-10 mt-10 ' + (s.confirm ? 'active':'')} onClick=${() => this.setState({confirm: !this.state.confirm})}>
                        Click to confirm
                    </button>
                </div>
